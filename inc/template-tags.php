 ...
 * @return string
 */
function get_thumbnail_src( $post_thumbnail_id, $size = 'full' ) {
    $thumbnail = wp_get_attachment_image_src( $post_thumbnail_id, $size );
    return @$thumbnail[0];
}
endif;

if ( ! function_exists( 'og_meta_tags' ) ) :
/**
...
function og_meta_tags() {
    ...
    ?>
        ...
        <meta name="og:image" content="<?php echo get_thumbnail_src( get_post_thumbnail_id() ); ?>">
